...
-[*BREAKING CHANGE*] Support chunked requests when upstream is plain HTTP 1.1. Request body was always buffered before this change. [PR #1405](https://github.com/3scale/APIcast/pull/1405)
